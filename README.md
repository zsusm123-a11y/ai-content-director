...
选题页通过后端读取抖音火热榜导航聚合的热点标题，默认 10 分钟缓存，只展示前 12 条并链接到抖音搜索。该来源是第三方公开热榜导航，并非抖音官方接口；抖音开放平台公告说明相关热点权限已停止新申请并开始回收。热点榜只提供标题和搜索链接，不提供视频播放量、点赞量或爆款视频分析。若要参考具体爆款视频，请粘贴视频链接，并手动补充看到的开头钩子、节奏或高赞评论；系统会把这段观察传给已配置的大模型。不会抓取或保存视频内容。
