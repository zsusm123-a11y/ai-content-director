...
test("SQLite store persists account, ideas, projects, events and selection state", async () => {
  ...
  assert.deepEqual(store.health(), { path, accounts: 1, ideas: 1, projects: 1, events: 1 });
  store.close();
